      ...
      <section className="container px-4 py-12 md:py-16">
        ...
        <div className="mt-6 space-y-6 text-sm leading-relaxed text-slate-700 dark:text-slate-200">
          ...
          <div className="space-y-2">
            <h2 className="text-base font-semibold text-slate-900 dark:text-slate-100">1. Dados coletados</h2>
            <p>
          ...
          <div className="space-y-2">
            <h2 className="text-base font-semibold text-slate-900 dark:text-slate-100">2. Pagamentos</h2>
            <p>
          ...
          <div className="space-y-2">
            <h2 className="text-base font-semibold text-slate-900 dark:text-slate-100">3. Compartilhamento</h2>
            <p>
          ...
          <div className="space-y-2">
            <h2 className="text-base font-semibold text-slate-900 dark:text-slate-100">4. Segurança</h2>
            <p>
          ...
          <div className="space-y-2">
            <h2 className="text-base font-semibold text-slate-900 dark:text-slate-100">5. Direitos do titular</h2>
            <p>
