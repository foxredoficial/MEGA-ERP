  ...
  return (
    <MarketingLayout>
      <section className="container px-4 py-12 md:py-16">
        <h1 className="text-3xl font-bold tracking-tight text-zinc-950 dark:text-white md:text-4xl">Termos de Uso</h1>
        <div className="mt-6 space-y-6 text-sm leading-relaxed text-zinc-700 dark:text-zinc-200">
          ...
          <div className="space-y-2">
            <h2 className="text-base font-semibold text-zinc-900 dark:text-zinc-100">1. Conta e acesso</h2>
            <p>
          ...
          <div className="space-y-2">
            <h2 className="text-base font-semibold text-zinc-900 dark:text-zinc-100">2. Planos e cobrança</h2>
            <p>
          ...
          <div className="space-y-2">
            <h2 className="text-base font-semibold text-zinc-900 dark:text-zinc-100">3. Uso aceitável</h2>
            <p>
          ...
          <div className="space-y-2">
            <h2 className="text-base font-semibold text-zinc-900 dark:text-zinc-100">4. Privacidade</h2>
            <p>
          ...
          <div className="space-y-2">
            <h2 className="text-base font-semibold text-zinc-900 dark:text-zinc-100">5. Alterações</h2>
            <p>
