      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-zinc-500 mt-1">Gerencie sua base de {title.toLowerCase()} de forma eficiente.</p>
          </div>
                  ...
                  <tr>
                    <td colSpan={6} className="px-6 py-12 text-center text-zinc-500">
                      <div className="flex flex-col items-center justify-center max-w-sm mx-auto">
                        ...
                        <h3 className="text-lg font-medium text-zinc-900 mb-1">Nenhum {isSupplier ? "fornecedor" : "cliente"} encontrado</h3>
                        <p className="text-zinc-500 mb-6">Comece adicionando seu primeiro {isSupplier ? "fornecedor" : "cliente"}.</p>
                        <Link to={`${basePath}/novo`}>
                    ...
                    <tr key={contact.id} className="hover:bg-blue-50/30 transition-colors group">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex flex-col">
                          <Link to={`${basePath}/${contact.id}`} className="font-semibold text-zinc-900 hover:text-blue-600 transition-colors">
                            {contact.name}
                          </Link>
